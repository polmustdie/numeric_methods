...
if __name__ == '__main__':
    ...
    sumXSecondDegree = aprx.calculateSumInAnyPower(listX, 2)
    sumXThirdDegree = aprx.calculateSumInAnyPower(listX, 3)
    sumXFourthDegree = aprx.calculateSumInAnyPower(listX, 4)

    normalSystemOfLeastSquares = aprx.mx.Matrix(3, 4, [sumXFourthDegree,
                                                       sumXThirdDegree,
                                                       sumXSecondDegree,
                                                       aprx.calculteSumOfMultiplyElements(listX, 2, listY),
                                                       sumXThirdDegree,
                                                       sumXSecondDegree,
                                                       sumXFirstDegree,
